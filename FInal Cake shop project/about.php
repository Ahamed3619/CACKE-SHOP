...
<html lang="en">
  ...
  <div class="wrapper">
    ...
    <section id="header">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
				 ...
				 <li id="activess"><a href="about.php">About Us</a></li>
			   ...
			   <section id="images-body"><!--image-body start-->
							...
							<div class="col-lg-12 no-padding">
							  ...
							  <div class="col-lg-8 col-sm-8">
								<div class="right-sidebar">
								  <h2 class="titles"> About Fairy Cake Shop <hr></h2>
								 
								  <p class="text">Check out the team below</p>
								  <a href="#click"data-uk-smooth-scroll="{offset: 90}"class="btn btn-prime btn-xl page-scroll">our team</a>
			    ...
			    <section id="new-body">
				 ...
				 <div class="container">
                    <div class="col-lg-12 no-padding">
						 ...
						 <div class="col-lg-6 col-md-12 col-sm-12"id="new">
								<div class="cake-names">
								
									<h3 style="text-align-center">Welcome to the Fairy Cake Shop</h3> 
									<hr>
									
									 <p class="lorem">Lorem ipsum dolor sit amet, consectetur corporis lab. Architecto, maiores, similique, eos, ea doloribus nihil accusantium fuga numquam corporis nostrum eligendi nemo sapiente quibusdam consequuntur tempore. Suscipit.</p>
					  ...
					  <div class="col-lg-6 col-md-12 col-sm-12  no-padding"id="click" >
	 ...
	 <section class="about-Team-meet"><!-- about team  section -->
        <div class="container">
            <h2 style="text-align:center;text-transform:uppercase;margin:20px 0px;color:#F34B0A">Meet the Team</h2>
            <div class="row mrg-t-20">
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail about-box">
                        <img src="img/tariq.jpg" alt="jason.jpg" class="img-responsive">
                        <div class="caption about-box-body">
                            <h6 class="designation">Owner / invigilator</h6>
                            ...
                            <p>
                                Owner of AutoClub, started the company
                                in 2005. A very hard working person who loves to drive the cars.
                            </p>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail about-box">
                        <img src="img/Tanver.jpg" alt="peter.jpg" class="img-responsive">
                        <div class="caption about-box-body">
                            <h6 class="designation">Owner / Technican</h6>
                           <div class="header b-items-cars-one-info-header  s-lineDownLeft">
                                <h3 class="name">
                                    Muhammod Tanvir
                                </h3>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail about-box">
                        <img src="img/habib.jpg" alt="paul.jpg" class="img-responsive">
                        <div class="caption about-box-body">
                            <h6 class="designation">Owner / reviewer</h6>
                            <div class="header b-items-cars-one-info-header  s-lineDownLeft">
                                <h3 class="name">
                                    Md.Habibur Rahman
                                </h3>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="thumbnail about-box">
                        <img src="img/seventeen.jpg" alt="maria.jpg" class="img-responsive">
                        <div class="caption about-box-body">
                            <h6 class="designation">owner / Representative</h6>
                            <div class="header b-items-cars-one-info-header  s-lineDownLeft">
                                <h3 class="name">
                                    Mrs.Bela
                                </h3>
